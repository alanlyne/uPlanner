...
const usersRef = dbRef.child('eventDetails/'+getCookie()+'/');
...
function userClicked(e) {
		...
		const userRef = dbRef.child('eventDetails/'+getCookie()+'/' + userID);
...
function editButtonClicked(e) {
	...
	const userRef = dbRef.child('eventDetails/'+getCookie()+'/' + e.target.getAttribute("userid"));
